...
namespace opr_ocenjevanje
{
    internal static class Program
    {
        ...
        // Polimorfizem: vsak podrazred prostora vrne svoj Opis() (override).
        public static List<string> PridobiPolimorfneOpise()
        {
            var opisi = new List<string>();
            foreach (IOpisljivo opisljivo in Prostori)
            {
                opisi.Add(opisljivo.Opis());
            }
